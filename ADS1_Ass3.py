...
def readFile(x):
    ...
    '''
    Data = pd.read_csv("/content/Ele_Cos.csv");
    Data = pd.read_csv(x)
    Data = Data.fillna(0.0)
    return Data
 
# calling function to show dataframe 
Data = readFile("/content/Ele_Cos.csv")
...
def readFile(y):
    ...
    '''
    annual_pop = pd.read_csv("/content/An_population.csv");
...
annual_pop = readFile("/content/An_population.csv")
